...
function printFunctionCode(func)
    local info = debug.getinfo(func, "S")
    print(info.source)  -- æ‰“å°å‡½æ•°çš„æºä»£ç æ–‡ä»¶è·¯å¾„ï¼ˆå¯ä»¥æ˜¯åŠ è½½è·¯å¾„ï¼‰
    print(info.linedefined)  -- æ‰“å°å®šä¹‰çš„ä½ç½®
end
