...
function Game:start_up()
    ...
    G.LOAD_MANAGER = {
        thread = love.thread.newThread('engine/load_manager.lua'),
        request_channel = love.thread.getChannel('load_request'),
        return_channel = love.thread.getChannel('load_return')
    }
    ...
    G.SAVE_MANAGER = {
        ...
        request_channel = love.thread.getChannel('save_request'),
        return_channel = love.thread.getChannel('save_return')
    }
...
function Game:init_item_prototypes()
    ...
    self.P_STAKES = self.P_STAKES or {
        ...
        stake_red =     {name = 'Red Chip',     unlocked = false, start_locked = true, order = 2, pos = {x = 1,y = 0}, stake_level = 2, set = 'Stake'},
        stake_green =   {name = 'Green Chip',   unlocked = false, start_locked = true, order = 3, pos = {x = 2,y = 0}, stake_level = 3, set = 'Stake'},  
        stake_black =   {name = 'Black Chip',   unlocked = false, start_locked = true, order = 4, pos = {x = 4,y = 0}, stake_level = 4, set = 'Stake'},
        stake_blue =    {name = 'Blue Chip',    unlocked = false, start_locked = true, order = 5, pos = {x = 3,y = 0}, stake_level = 5, set = 'Stake'},
    ...
    self.P_BLINDS = self.P_BLINDS or {
        bl_small =           {name = 'Small Blind',  demo = false, defeated = false, order = 1, dollars = 3, mult = 1,  vars = {}, debuff_text = '', debuff = {}, pos = {x=0, y=0}},
        bl_big =             {name = 'Big Blind',    demo = false, defeated = false, order = 2, dollars = 4, mult = 1.5,vars = {}, debuff_text = '', debuff = {}, pos = {x=0, y=1}},
        bl_ox =              {name = 'The Ox',       demo = false, defeated = false, order = 4, dollars = 5, mult = 2,  vars = {localize('ph_most_played')}, debuff = {}, pos = {x=0, y=2}, boss = {min = 6, max = 10}, boss_colour = HEX('b95b08')},
        bl_hook =            {name = 'The Hook',     demo = false, defeated = false, order = 3, dollars = 5, mult = 2,  vars = {}, debuff = {}, pos = {x=0, y=7}, boss = {min = 1, max = 10}, boss_colour = HEX('a84024')},
        bl_mouth =           {name = 'The Mouth',    demo = false, defeated = false, order = 17, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=18}, boss = {min = 2, max = 10}, boss_colour = HEX('ae718e')},
        bl_fish =            {name = 'The Fish',     demo = false, defeated = false, order = 10, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=5}, boss = {min = 2, max = 10}, boss_colour = HEX('3e85bd')},
        bl_club =            {name = 'The Club',     demo = false, defeated = false, order = 9, dollars = 5, mult = 2,  vars = {}, debuff = {suit = 'Clubs'}, pos = {x=0, y=4}, boss = {min = 1, max = 10}, boss_colour = HEX('b9cb92')},
        bl_manacle =         {name = 'The Manacle',  demo = false, defeated = false, order = 15, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=8}, boss = {min = 1, max = 10}, boss_colour = HEX('575757')},
        bl_tooth =           {name = 'The Tooth',    demo = false, defeated = false, order = 23, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=22}, boss = {min = 3, max = 10}, boss_colour = HEX('b52d2d')},
        bl_wall =            {name = 'The Wall',     demo = false, defeated = false, order = 6, dollars = 5, mult = 4,  vars = {}, debuff = {}, pos = {x=0, y=9}, boss = {min = 2, max = 10}, boss_colour = HEX('8a59a5')},
        bl_house =           {name = 'The House',    demo = false, defeated = false, order = 5, dollars = 5, mult = 2,  vars = {}, debuff = {}, pos = {x=0, y=3}, boss ={min = 2, max = 10}, boss_colour = HEX('5186a8')},
        bl_mark =            {name = 'The Mark',     demo = false, defeated = false, order = 25, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=23}, boss = {min = 2, max = 10}, boss_colour = HEX('6a3847')},

        bl_final_bell =      {name = 'Cerulean Bell',demo = false, defeated = false, order = 30, dollars = 8, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=26}, boss = {showdown = true, min = 10, max = 10}, boss_colour = HEX('009cfd')},

        bl_wheel =           {name = 'The Wheel',    demo = true, defeated = false, order = 7, dollars = 5, mult = 2,  vars = {}, debuff = {}, pos = {x=0, y=10}, boss = {min = 2, max = 10}, boss_colour = HEX('50bf7c')},
        bl_arm =             {name = 'The Arm',      demo = true, defeated = false, order = 8, dollars = 5, mult = 2,  vars = {}, debuff = {}, pos = {x=0, y=11}, boss = {min = 2, max = 10}, boss_colour = HEX('6865f3')},
        bl_psychic =         {name = 'The Psychic',  demo = true, defeated = false, order = 11, dollars = 5, mult = 2, vars = {}, debuff = {h_size_ge = 5}, pos = {x=0, y=12}, boss = {min = 1, max = 10}, boss_colour = HEX('efc03c')},
        bl_goad =            {name = 'The Goad',     demo = true, defeated = false, order = 12, dollars = 5, mult = 2, vars = {}, debuff = {suit = 'Spades'}, pos = {x=0, y=13}, boss = {min = 1, max = 10}, boss_colour = HEX('b95c96')},
        bl_water =           {name = 'The Water',    demo = true, defeated = false, order = 13, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=14}, boss = {min = 2, max = 10}, boss_colour = HEX('c6e0eb')},
        bl_eye =             {name = 'The Eye',      demo = true, defeated = false, order = 16, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=17}, boss = {min = 3, max = 10}, boss_colour = HEX('4b71e4')},
        bl_plant =           {name = 'The Plant',    demo = true, defeated = false, order = 18, dollars = 5, mult = 2, vars = {}, debuff = {is_face = 'face'}, pos = {x=0, y=19}, boss = {min = 4, max = 10}, boss_colour = HEX('709284')},
        bl_needle =          {name = 'The Needle',   demo = true, defeated = false, order = 21, dollars = 5, mult = 1, vars = {}, debuff = {}, pos = {x=0, y=20}, boss = {min = 2, max = 10}, boss_colour = HEX('5c6e31')},
        bl_head =            {name = 'The Head',     demo = true, defeated = false, order = 22, dollars = 5, mult = 2, vars = {}, debuff = {suit = 'Hearts'}, pos = {x=0, y=21}, boss = {min = 1, max = 10}, boss_colour = HEX('ac9db4')},
        bl_final_leaf =      {name = 'Verdant Leaf', demo = true, defeated = false, order = 27, dollars = 8, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=28}, boss = {showdown = true, min = 10, max = 10}, boss_colour = HEX('56a786')},
        bl_final_vessel =    {name = 'Violet Vessel',demo = true, defeated = false, order = 28, dollars = 8, mult = 6, vars = {}, debuff = {}, pos = {x=0, y=29}, boss = {showdown = true, min = 10, max = 10}, boss_colour = HEX('8a71e1')},
        bl_window =          {name = 'The Window',   demo = true, defeated = false, order = 14, dollars = 5, mult = 2, vars = {}, debuff = {suit = 'Diamonds'}, pos = {x=0, y=6}, boss = {min = 1, max = 10}, boss_colour = HEX('a9a295')},
        bl_serpent =         {name = 'The Serpent',  demo = true, defeated = false, order = 19, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=15}, boss = {min = 5, max = 10}, boss_colour = HEX('439a4f')},
        bl_pillar =          {name = 'The Pillar',   demo = true, defeated = false, order = 20, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=16}, boss = {min = 1, max = 10}, boss_colour = HEX('7e6752')},
        bl_flint =           {name = 'The Flint',    demo = true, defeated = false, order = 24, dollars = 5, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=24}, boss = {min = 2, max = 10}, boss_colour = HEX('e56a2f')},
        bl_final_acorn =     {name = 'Amber Acorn',  demo = true, defeated = false, order = 26, dollars = 8, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=27}, boss = {showdown = true, min = 10, max = 10}, boss_colour = HEX('fda200')},
        bl_final_heart =     {name = 'Crimson Heart',demo = true, defeated = false, order = 29, dollars = 8, mult = 2, vars = {}, debuff = {}, pos = {x=0, y=25}, boss = {showdown = true, min = 10, max = 10}, boss_colour = HEX('ac3232')},
    }
    self.b_undiscovered = self.b_undiscovered or {name = 'Undiscovered', debuff_text = 'Defeat this blind to discover', pos = {x=0,y=30}}

    self.P_CARDS = self.P_CARDS or {
    ...
    self.P_CENTERS = self.P_CENTERS or {
        c_base={max = 500, freq = 1, line = 'base', start_alerted = true, discovered = true, start_discovered = true, name = "Default Base", pos = {x=1,y=0}, set = "Default", label = 'Base Card', effect = "Base", cost_mult = 1.0, config = {}},
        ...
        j_lusty_joker=      {order = 3,  unlocked = true,   demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Lusty Joker", pos = {x=7,y=1}, set = "Joker", effect = "Suit Mult", cost_mult = 1.0, config = {extra = {s_mult = 3, suit = 'Hearts'}}},
        j_wrathful_joker=   {order = 4,  unlocked = true,   demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Wrathful Joker", pos = {x=8,y=1}, set = "Joker", effect = "Suit Mult", cost_mult = 1.0, config = {extra = {s_mult = 3, suit = 'Spades'}}},
        j_gluttenous_joker= {order = 5,  unlocked = true,   demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Gluttonous Joker", pos = {x=9,y=1}, set = "Joker", effect = "Suit Mult", cost_mult = 1.0, config = {extra = {s_mult = 3, suit = 'Clubs'}}},
        j_jolly=            {order = 6,  unlocked = true,   demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Jolly Joker", pos = {x=2,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 8, type = 'Pair'}},
        j_zany=             {order = 7,  unlocked = true,   demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Zany Joker", pos = {x=3,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 12, type = 'Three of a Kind'}},
        j_mad=              {order = 8,  unlocked = true,   demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Mad Joker", pos = {x=4,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 10, type = 'Two Pair'}},
        j_crazy=            {order = 9,  unlocked = true,   demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Crazy Joker", pos = {x=5,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 12, type = 'Straight'}},
        j_droll=            {order = 10,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Droll Joker", pos = {x=6,y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {t_mult = 10, type = 'Flush'}},
        j_sly=              {order = 11,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Sly Joker",set = "Joker", config = {t_chips = 50, type = 'Pair'}, pos = {x=0,y=14}},
        j_wily=             {order = 12,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Wily Joker",set = "Joker", config = {t_chips = 100, type = 'Three of a Kind'}, pos = {x=1,y=14}},
        j_clever=           {order = 13,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Clever Joker",set = "Joker", config = {t_chips = 80, type = 'Two Pair'}, pos = {x=2,y=14}},
        j_devious=          {order = 14,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Devious Joker",set = "Joker", config = {t_chips = 100, type = 'Straight'}, pos = {x=3,y=14}},
        j_crafty=           {order = 15,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Crafty Joker",set = "Joker", config = {t_chips = 80, type = 'Flush'}, pos = {x=4,y=14}},

        j_half=             {order = 16,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Half Joker", pos = {x=7,y=0}, set = "Joker", effect = "Hand Size Mult", cost_mult = 1.0, config = {extra = {mult = 20, size = 3}}},
        j_stencil=          {order = 17,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Joker Stencil", pos = {x=2,y=5}, set = "Joker", effect = "Hand Size Mult", cost_mult = 1.0, config = {}},
        j_four_fingers=     {order = 18,  unlocked = true,  demo = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Four Fingers", pos = {x=6,y=6}, set = "Joker", effect = "", config = {}},
        j_mime=             {order = 19,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Mime", pos = {x=4,y=1}, set = "Joker", effect = "Hand card double", cost_mult = 1.0, config = {extra = 1}},
        j_credit_card=      {order = 20,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 1, name = "Credit Card", pos = {x=5,y=1}, set = "Joker", effect = "Credit", cost_mult = 1.0, config = {extra = 20}},
        j_ceremonial=       {order = 21,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Ceremonial Dagger", pos = {x=5,y=5}, set = "Joker", effect = "", config = {mult = 0}},
        j_banner=           {order = 22,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Banner", pos = {x=1,y=2}, set = "Joker", effect = "Discard Chips", cost_mult = 1.0, config = {extra = 30}},
        j_mystic_summit=    {order = 23,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Mystic Summit", pos = {x=2,y=2}, set = "Joker", effect = "No Discard Mult", cost_mult = 1.0, config = {extra = {mult = 15, d_remaining = 0}}},
        ...
        j_fibonacci=        {order = 31,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Fibonacci", pos = {x=1,y=5}, set = "Joker", effect = "Card Mult", cost_mult = 1.0, config = {extra = 8}},
        j_steel_joker=      {order = 32,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Steel Joker", pos = {x=7,y=2}, set = "Joker", effect = "Steel Card Buff", cost_mult = 1.0, config = {extra = 0.2}, enhancement_gate = 'm_steel'},
        j_scary_face=       {order = 33,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Scary Face", pos = {x=2,y=3}, set = "Joker", effect = "Scary Face Cards", cost_mult = 1.0, config = {extra = 30}},
        j_abstract=         {order = 34,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Abstract Joker", pos = {x=3,y=3}, set = "Joker", effect = "Joker Mult", cost_mult = 1.0, config = {extra = 3}},
        j_delayed_grat=     {order = 35,  unlocked = true,  demo = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Delayed Gratification", pos = {x=4,y=3}, set = "Joker", effect = "Discard dollars", cost_mult = 1.0, config = {extra = 2}},
        j_hack=             {order = 36,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Hack", pos = {x=5,y=2}, set = "Joker", effect = "Low Card double", cost_mult = 1.0, config = {extra = 1}},
        j_pareidolia=       {order = 37,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Pareidolia", pos = {x=6,y=3}, set = "Joker", effect = "All face cards", cost_mult = 1.0, config = {}},
        j_gros_michel=      {order = 38,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 1, cost = 5, name = "Gros Michel", pos = {x=7,y=6}, set = "Joker", effect = "", config = {extra = {odds = 6, mult = 15}}, no_pool_flag = 'gros_michel_extinct'},
        j_even_steven=      {order = 39,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Even Steven", pos = {x=8,y=3}, set = "Joker", effect = "Even Card Buff", cost_mult = 1.0, config = {extra = 4}},
        j_odd_todd=         {order = 40,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Odd Todd", pos = {x=9,y=3}, set = "Joker", effect = "Odd Card Buff", cost_mult = 1.0, config = {extra = 31}},
        j_scholar=          {order = 41,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Scholar", pos = {x=0,y=4}, set = "Joker", effect = "Ace Buff", cost_mult = 1.0, config = {extra = {mult = 4, chips = 20}}},
        j_business=         {order = 42,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Business Card", pos = {x=1,y=4}, set = "Joker", effect = "Face Card dollar Chance", cost_mult = 1.0, config = {extra = 2}},
        j_supernova=        {order = 43,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Supernova", pos = {x=2,y=4}, set = "Joker", effect = "Hand played mult", cost_mult = 1.0, config = {extra = 1}},
        j_ride_the_bus=     {order = 44,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 1, cost = 6, name = "Ride the Bus", pos = {x=1,y=6}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = 'discard_custom'}},
        j_space=            {order = 45,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Space Joker", pos = {x=3,y=5}, set = "Joker", effect = "Upgrade Hand chance", cost_mult = 1.0, config = {extra = 4}},
        
        j_egg=              {order = 46,  unlocked = true,  demo = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = 'Egg', pos = {x = 0, y = 10}, set = 'Joker', config = {extra = 3}},
        j_burglar=          {order = 47,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Burglar', pos = {x = 1, y = 10}, set = 'Joker', config = {extra = 3}},
        j_blackboard=       {order = 48,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Blackboard', pos = {x = 2, y = 10}, set = 'Joker', config = {extra = 3}},
        j_runner=           {order = 49,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 1, cost = 5, name = 'Runner', pos = {x = 3, y = 10}, set = 'Joker', config = {extra = {chips = 0, chip_mod = 15}}},
        j_ice_cream=        {order = 50,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 1, cost = 5, name = 'Ice Cream', pos = {x = 4, y = 10}, set = 'Joker', config = {extra = {chips = 100, chip_mod = 5}}},
        j_dna=              {order = 51,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = 'DNA', pos = {x = 5, y = 10}, set = 'Joker', config = {}},
        j_splash=           {order = 52,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = 'Splash', pos = {x = 6, y = 10}, set = 'Joker', config = {}},
        j_blue_joker=       {order = 53,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = 'Blue Joker', pos = {x = 7, y = 10}, set = 'Joker', config = {extra = 2}},
        j_sixth_sense=      {order = 54,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = 'Sixth Sense', pos = {x = 8, y = 10}, set = 'Joker', config = {}},
        j_constellation=    {order = 55,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = 'Constellation', pos = {x = 9, y = 10}, set = 'Joker', config = {extra = 0.1, Xmult = 1}},
        j_hiker=            {order = 56,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = 'Hiker', pos = {x = 0, y = 11}, set = 'Joker', config = {extra = 5}},
        j_faceless=         {order = 57,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = 'Faceless Joker', pos = {x = 1, y = 11}, set = 'Joker', config = {extra = {dollars = 5, faces = 3}}},
        j_green_joker=      {order = 58,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 1, cost = 4, name = 'Green Joker', pos = {x = 2, y = 11}, set = 'Joker', config = {extra = {hand_add = 1, discard_sub = 1}}},
        j_superposition=    {order = 59,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = 'Superposition', pos = {x = 3, y = 11}, set = 'Joker', config = {}},
        j_todo_list=        {order = 60,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = 'To Do List', pos = {x = 4, y = 11}, set = 'Joker', config = {extra = {dollars = 4, poker_hand = 'High Card'}}},

        j_cavendish=        {order = 61,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 1, cost = 4, name = "Cavendish", pos = {x=5,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = {odds = 1000, Xmult = 3}}, yes_pool_flag = 'gros_michel_extinct'},
        j_card_sharp=       {order = 62,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Card Sharp", pos = {x=6,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = {Xmult = 3}}},
        j_red_card=         {order = 63,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 1, cost = 5, name = "Red Card", pos = {x=7,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = 3}},
        j_madness=          {order = 64,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 7, name = "Madness", pos = {x=8,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = 0.5}},
        j_square=           {order = 65,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 1, cost = 4, name = "Square Joker", pos = {x=9,y=11}, set = "Joker", cost_mult = 1.0, config = {extra = {chips = 0, chip_mod = 4}}},
        j_seance=           {order = 66,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Seance", pos = {x=0,y=12}, set = "Joker", cost_mult = 1.0, config = {extra = {poker_hand = 'Straight Flush'}}},
        j_riff_raff=        {order = 67,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 6, name = "Riff-raff", pos = {x=1,y=12}, set = "Joker", cost_mult = 1.0, config = {extra = 2}},
        j_vampire=          {order = 68,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 7, name = "Vampire",set = "Joker", config = {extra = 0.1, Xmult = 1},  pos = {x=2,y=12}},
        j_shortcut=         {order = 69,  unlocked = true,  demo = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Shortcut",set = "Joker", config = {},  pos = {x=3,y=12}},
        j_hologram=         {order = 70,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 7, name = "Hologram",set = "Joker", config = {extra = 0.25, Xmult = 1},  pos = {x=4,y=12}, soul_pos = {x=2, y=9},},
        j_vagabond=         {order = 71,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Vagabond",set = "Joker", config = {extra = 4}, pos = {x=5,y=12}},
        j_baron=            {order = 72,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Baron",set = "Joker", config = {extra = 1.5}, pos = {x=6,y=12}},
        j_cloud_9=          {order = 73,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Cloud 9",set = "Joker", config = {extra = 1}, pos = {x=7,y=12}},
        j_rocket=           {order = 74,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Rocket",set = "Joker", config = {extra = {dollars = 1, increase = 2}}, pos = {x=8,y=12}},
        j_obelisk=          {order = 75,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 3, cost = 8, name = "Obelisk",set = "Joker", config = {extra = 0.2, Xmult = 1}, pos = {x=9,y=12}},

        j_midas_mask=       {order = 76,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Midas Mask",set = "Joker", config = {}, pos = {x=0,y=13}},
        j_luchador=         {order = 77,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 5, name = "Luchador",set = "Joker", config = {}, pos = {x=1,y=13}},
        j_photograph=       {order = 78,  unlocked = true,  demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Photograph",set = "Joker", config = {extra = 2}, pos = {x=2,y=13}},
        j_gift=             {order = 79,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Gift Card",set = "Joker", config = {extra = 1}, pos = {x=3,y=13}},
        j_turtle_bean=      {order = 80,  unlocked = true,  demo = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Turtle Bean",set = "Joker", config = {extra = {h_size = 5, h_mod = 1}}, pos = {x=4,y=13}},
        j_erosion=          {order = 81,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Erosion",set = "Joker", config = {extra = 4}, pos = {x=5,y=13}},
        j_reserved_parking= {order = 82,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 6, name = "Reserved Parking",set = "Joker", config = {extra = {odds = 2, dollars = 1}}, pos = {x=6,y=13}},
        j_mail=             {order = 83,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Mail-In Rebate",set = "Joker", config = {extra = 5}, pos = {x=7,y=13}},
        j_to_the_moon=      {order = 84,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "To the Moon",set = "Joker", config = {extra = 1}, pos = {x=8,y=13}},
        j_hallucination=    {order = 85,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Hallucination",set = "Joker", config = {extra = 2}, pos = {x=9,y=13}},
        j_fortune_teller=   {order = 86,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 6, name = "Fortune Teller", pos = {x=7,y=5}, set = "Joker", effect = "", config = {extra = 1}},
        j_juggler=          {order = 87,  unlocked = true,  demo = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Juggler", pos = {x=0,y=1}, set = "Joker", effect = "Hand Size", cost_mult = 1.0, config = {h_size = 1}},
        j_drunkard=         {order = 88,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Drunkard", pos = {x=1,y=1}, set = "Joker", effect = "Discard Size", cost_mult = 1.0, config = {d_size = 1}},
        j_stone=            {order = 89,  unlocked = true,  demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Stone Joker", pos = {x=9,y=0}, set = "Joker", effect = "Stone Card Buff", cost_mult = 1.0, config = {extra = 25}, enhancement_gate = 'm_stone'},
        j_golden=           {order = 90,  unlocked = true,  demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 6, name = "Golden Joker", pos = {x=9,y=2}, set = "Joker", effect = "Bonus dollars", cost_mult = 1.0, config = {extra = 4}},

        j_lucky_cat=        {order = 91,   unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Lucky Cat",set = "Joker", config = {Xmult = 1, extra = 0.25}, pos = {x=5,y=14}, enhancement_gate = 'm_lucky'},
        j_baseball=         {order = 92,   unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Baseball Card",set = "Joker", config = {extra = 1.5}, pos = {x=6,y=14}},
        j_bull=             {order = 93,   unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Bull",set = "Joker", config = {extra = 2}, pos = {x=7,y=14}},
        j_diet_cola=        {order = 94,   unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Diet Cola",set = "Joker", config = {}, pos = {x=8,y=14}},
        j_trading=          {order = 95,   unlocked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Trading Card",set = "Joker", config = {extra = 3}, pos = {x=9,y=14}},
        j_flash=            {order = 96,   unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 5, name = "Flash Card",set = "Joker", config = {extra = 2, mult = 0}, pos = {x=0,y=15}},
        j_popcorn=          {order = 97,   unlocked = true, demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 1, cost = 5, name = "Popcorn",set = "Joker", config = {mult = 20, extra = 4}, pos = {x=1,y=15}},
        j_trousers=         {order = 98,   unlocked = true, demo = false, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Spare Trousers",set = "Joker", config = {extra = 2}, pos = {x=4,y=15}},
        j_ancient=          {order = 99,   unlocked = true, demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Ancient Joker",set = "Joker", config = {extra = 1.5}, pos = {x=7,y=15}},
        j_ramen=            {order = 100,  unlocked = true, demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Ramen",set = "Joker", config = {Xmult = 2, extra = 0.01}, pos = {x=2,y=15}},
        j_walkie_talkie=    {order = 101,  unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Walkie Talkie",set = "Joker", config = {extra = {chips = 10, mult = 4}}, pos = {x=8,y=15}},
        j_selzer=           {order = 102,  unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 6, name = "Seltzer",set = "Joker", config = {extra = 10}, pos = {x=3,y=15}},
        j_castle=           {order = 103,  unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 2, cost = 6, name = "Castle",set = "Joker", config = {extra = {chips = 0, chip_mod = 3}}, pos = {x=9,y=15}},
        j_smiley=           {order = 104,  unlocked = true, demo = false, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Smiley Face",set = "Joker", config = {extra = 5}, pos = {x=6,y=15}},
        j_campfire=         {order = 105,  unlocked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 9, name = "Campfire",set = "Joker", config = {extra = 0.25}, pos = {x=5,y=15}},

        j_ticket=           {order = 106,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Golden Ticket", pos = {x=5,y=3}, set = "Joker", effect = "dollars for Gold cards", cost_mult = 1.0, config = {extra = 4},unlock_condition = {type = 'hand_contents', extra = 'Gold'}, enhancement_gate = 'm_gold'},
        j_mr_bones=         {order = 107,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 5, name = "Mr. Bones", pos = {x=3,y=4}, set = "Joker", effect = "Prevent Death", cost_mult = 1.0, config = {},unlock_condition = {type = 'c_losses', extra = 5}},
        j_acrobat=          {order = 108,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Acrobat", pos = {x=2,y=1}, set = "Joker", effect = "Shop size", cost_mult = 1.0, config = {extra = 3},unlock_condition = {type = 'c_hands_played', extra = 200}},
        j_sock_and_buskin=  {order = 109,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Sock and Buskin", pos = {x=3,y=1}, set = "Joker", effect = "Face card double", cost_mult = 1.0, config = {extra = 1},unlock_condition = {type = 'c_face_cards_played', extra = 300}},
        j_swashbuckler=     {order = 110,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Swashbuckler", pos = {x=9,y=5}, set = "Joker", effect = "Set Mult", cost_mult = 1.0, config = {mult = 1},unlock_condition = {type = 'c_jokers_sold', extra = 20}},
        j_troubadour=       {order = 111,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Troubadour", pos = {x=0,y=2}, set = "Joker", effect = "Hand Size, Plays", cost_mult = 1.0, config = {extra = {h_size = 2, h_plays = -1}}, unlock_condition = {type = 'round_win', extra = 5}},
        j_certificate=      {order = 112,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Certificate", pos = {x=8,y=8}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'double_gold'}},
        j_smeared=          {order = 113,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Smeared Joker", pos = {x=4,y=6}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'modify_deck', extra = {count = 3, enhancement = 'Wild Card', e_key = 'm_wild'}}},
        j_throwback=        {order = 114,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Throwback", pos = {x=5,y=7}, set = "Joker", effect = "", config = {extra = 0.25}, unlock_condition = {type = 'continue_game'}},        
        j_hanging_chad=     {order = 115,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Hanging Chad", pos = {x=9,y=6}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = 'round_win', extra = 'High Card'}},
        j_rough_gem=        {order = 116,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Rough Gem", pos = {x=9,y=7}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Diamonds'}}},
        j_bloodstone=       {order = 117,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Bloodstone", pos = {x=0,y=8}, set = "Joker", effect = "", config = {extra = {odds = 2, Xmult = 1.5}}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Hearts'}}},
        j_arrowhead=        {order = 118,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Arrowhead", pos = {x=1,y=8}, set = "Joker", effect = "", config = {extra = 50}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Spades'}}},
        j_onyx_agate=       {order = 119,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Onyx Agate", pos = {x=2,y=8}, set = "Joker", effect = "", config = {extra = 7}, unlock_condition = {type = 'modify_deck', extra = {count = 30, suit = 'Clubs'}}},
        ...
        j_ring_master=      {order = 121,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Showman", pos = {x=6,y=5}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'ante_up', ante = 4}},
        j_flower_pot=       {order = 122,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Flower Pot", pos = {x=0,y=6}, set = "Joker", effect = "", config = {extra = 3}, unlock_condition = {type = 'ante_up', ante = 8}},
        j_blueprint=        {order = 123,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 10,name = "Blueprint", pos = {x=0,y=3}, set = "Joker", effect = "Copycat", cost_mult = 1.0, config = {},unlock_condition = {type = 'win_custom'}},
        j_wee=              {order = 124,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 3, cost = 8, name = "Wee Joker", pos = {x=0,y=0}, set = "Joker", effect = "", config = {extra = {chips = 0, chip_mod = 8}}, unlock_condition = {type = 'win', n_rounds = 18}},
        j_merry_andy=       {order = 125,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Merry Andy", pos = {x=8,y=0}, set = "Joker", effect = "", cost_mult = 1.0, config = {d_size = 3, h_size = -1}, unlock_condition = {type = 'win', n_rounds = 12}},
        j_oops=             {order = 126,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 4, name = "Oops! All 6s", pos = {x=5,y=6}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'chip_score', chips = 10000}},
        j_idol=             {order = 127,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "The Idol", pos = {x=6,y=7}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = 'chip_score', chips = 1000000}},
        j_seeing_double=    {order = 128,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Seeing Double", pos = {x=4,y=4}, set = "Joker", effect = "X1.5 Mult club 7", cost_mult = 1.0, config = {extra = 2},unlock_condition = {type = 'hand_contents', extra = 'four 7 of Clubs'}},
        j_matador=          {order = 129,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Matador", pos = {x=4,y=5}, set = "Joker", effect = "", config = {extra = 8}, unlock_condition = {type = 'round_win'}},
        j_hit_the_road=     {order = 130,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Hit the Road", pos = {x=8,y=5}, set = "Joker", effect = "Jack Discard Effect", cost_mult = 1.0, config = {extra = 0.5}, unlock_condition = {type = 'discard_custom'}},
        j_duo=              {order = 131,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "The Duo", pos = {x=5,y=4}, set = "Joker", effect = "X1.5 Mult", cost_mult = 1.0, config = {Xmult = 2, type = 'Pair'}, unlock_condition = {type = 'win_no_hand', extra = 'Pair'}},
        j_trio=             {order = 132,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "The Trio", pos = {x=6,y=4}, set = "Joker", effect = "X2 Mult", cost_mult = 1.0, config = {Xmult = 3, type = 'Three of a Kind'}, unlock_condition = {type = 'win_no_hand', extra = 'Three of a Kind'}},
        j_family=           {order = 133,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "The Family", pos = {x=7,y=4}, set = "Joker", effect = "X3 Mult", cost_mult = 1.0, config = {Xmult = 4, type = 'Four of a Kind'}, unlock_condition = {type = 'win_no_hand', extra = 'Four of a Kind'}},
        j_order=            {order = 134,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "The Order", pos = {x=8,y=4}, set = "Joker", effect = "X3 Mult", cost_mult = 1.0, config = {Xmult = 3, type = 'Straight'}, unlock_condition = {type = 'win_no_hand', extra = 'Straight'}},
        j_tribe=            {order = 135,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "The Tribe", pos = {x=9,y=4}, set = "Joker", effect = "X3 Mult", cost_mult = 1.0, config = {Xmult = 2, type = 'Flush'}, unlock_condition = {type = 'win_no_hand', extra = 'Flush'}},
        
        j_stuntman=         {order = 136,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 7, name = "Stuntman", pos = {x=8,y=6}, set = "Joker", effect = "", config = {extra = {h_size = 2, chip_mod = 250}}, unlock_condition = {type = 'chip_score', chips = 100000000}},
        j_invisible=        {order = 137,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 3, cost = 8, name = "Invisible Joker", pos = {x=1,y=7}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = 'win_custom'}},
        j_brainstorm=       {order = 138,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 10, name = "Brainstorm", pos = {x=7,y=7}, set = "Joker", effect = "Copycat", config = {}, unlock_condition = {type = 'discard_custom'}},
        j_satellite=        {order = 139,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Satellite", pos = {x=8,y=7}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = 'money', extra = 400}},
        j_shoot_the_moon=   {order = 140,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 5, name = "Shoot the Moon", pos = {x=2,y=6}, set = "Joker", effect = "", config = {extra = 13}, unlock_condition = {type = 'play_all_hearts'}},
        j_drivers_license=  {order = 141,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 7, name = "Driver's License", pos = {x=0,y=7}, set = "Joker", effect = "", config = {extra = 3}, unlock_condition = {type = 'modify_deck', extra = {count = 16, tally = 'total'}}},
        j_cartomancer=      {order = 142,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Cartomancer", pos = {x=7,y=3}, set = "Joker", effect = "Tarot Buff", cost_mult = 1.0, config = {}, unlock_condition = {type = 'discover_amount', tarot_count = 22}},
        j_astronomer=       {order = 143,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Astronomer", pos = {x=2,y=7}, set = "Joker", effect = "", config = {}, unlock_condition = {type = 'discover_amount', planet_count = 12}},
        j_burnt=            {order = 144,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Burnt Joker", pos = {x=3,y=7}, set = "Joker", effect = "", config = {h_size = 0, extra = 4}, unlock_condition = {type = 'c_cards_sold', extra = 50}},
        j_bootstraps=       {order = 145,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Bootstraps", pos = {x=9,y=8}, set = "Joker", effect = "", config = {extra = {mult = 2, dollars = 5}}, unlock_condition = {type = 'modify_jokers', extra = {polychrome = true, count = 2}}},
        j_caino=            {order = 146,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Caino", pos = {x=3,y=8}, soul_pos = {x=3, y=9}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = '', extra = '', hidden = true}},
        j_triboulet=        {order = 147,  unlocked = false, start_locked = true, demo = true, discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Triboulet", pos = {x=4,y=8}, soul_pos = {x=4, y=9}, set = "Joker", effect = "", config = {extra = 2}, unlock_condition = {type = '', extra = '', hidden = true}},
        ...
        c_soul=             {order = 17,   discovered = false, cost = 4, demo = true, consumeable = true, name = "The Soul", pos = {x=2,y=2}, set = "Spectral", effect = "Unlocker", config = {}, hidden = true},
        c_black_hole=       {order = 18,   discovered = false, cost = 4, demo = true, consumeable = true, name = "Black Hole", pos = {x=9,y=3}, set = "Spectral", config = {}, hidden = true},

        --Vouchers
        v_overstock_norm =  {order = 1,     discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Overstock", pos = {x=0,y=0}, set = "Voucher", config = {}},
        v_clearance_sale=   {order = 3,     discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Clearance Sale", pos = {x=3,y=0}, set = "Voucher", config = {extra = 25}},
        v_hone=             {order = 5,     discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Hone", pos = {x=4,y=0}, set = "Voucher", config = {extra = 2}},
        v_reroll_surplus=   {order = 7,     discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Reroll Surplus", pos = {x=0,y=2}, set = "Voucher", config = {extra = 2}},
        v_crystal_ball=     {order = 9,     discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Crystal Ball", pos = {x=2,y=2}, set = "Voucher", config = {extra = 3}},
        v_telescope=        {order = 11,    discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Telescope", pos = {x=3,y=2}, set = "Voucher", config = {extra = 3}},
        v_grabber=          {order = 13,    discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Grabber", pos = {x=5,y=0}, set = "Voucher", config = {extra = 1}},
        v_wasteful=         {order = 15,    discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Wasteful", pos = {x=6,y=0}, set = "Voucher", config = {extra = 1}},
        v_tarot_merchant=   {order = 17,    discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Tarot Merchant", pos = {x=1,y=0}, set = "Voucher", config = {extra = 9.6/4, extra_disp = 2}},
        v_planet_merchant=  {order = 19,    discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Planet Merchant", pos = {x=2,y=0}, set = "Voucher", config = {extra = 9.6/4, extra_disp = 2}},
        v_seed_money=       {order = 21,    discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Seed Money", pos = {x=1,y=2}, set = "Voucher", config = {extra = 50}},
        v_blank=            {order = 23,    discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Blank", pos = {x=7,y=0}, set = "Voucher", config = {extra = 5}},
        v_magic_trick=      {order = 25,    discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Magic Trick", pos = {x=4,y=2}, set = "Voucher", config = {extra = 4}},
        v_hieroglyph=       {order = 27,    discovered = false, demo = true, unlocked = true , available = true, cost = 10, name = "Hieroglyph", pos = {x=5,y=2}, set = "Voucher", config = {extra = 1}},
        v_directors_cut=    {order = 29,    discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Director's Cut", pos = {x=6,y=2}, set = "Voucher", config = {extra = 10}},
        v_paint_brush=      {order = 31,    discovered = false, demo = false, unlocked = true , available = true, cost = 10, name = "Paint Brush", pos = {x=7,y=2}, set = "Voucher", config = {extra = 1}},
  
        v_overstock_plus=   {order = 2,     discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Overstock Plus", pos = {x=0,y=1}, set = "Voucher", config = {}, requires = {'v_overstock_norm'},unlock_condition = {type = 'c_shop_dollars_spent', extra = 2500}},
        v_liquidation=      {order = 4,     discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Liquidation", pos = {x=3,y=1}, set = "Voucher", config = {extra = 50}, requires = {'v_clearance_sale'},unlock_condition = {type = 'run_redeem', extra = 10}},
        v_glow_up=          {order = 6,     discovered = false, demo = true, unlocked = false, start_locked = true, available = true,  cost = 10, name = "Glow Up", pos = {x=4,y=1}, set = "Voucher", config = {extra = 4}, requires = {'v_hone'},unlock_condition = {type = 'have_edition', extra = 5}},
        v_reroll_glut=      {order = 8,     discovered = false, demo = true, unlocked = false, start_locked = true, available = true,  cost = 10, name = "Reroll Glut", pos = {x=0,y=3}, set = "Voucher", config = {extra = 2}, requires = {'v_reroll_surplus'},unlock_condition = {type = 'c_shop_rerolls', extra = 100}},
        v_omen_globe=       {order = 10,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Omen Globe", pos = {x=2,y=3}, set = "Voucher", config = {extra = 4}, requires = {'v_crystal_ball'},unlock_condition = {type = 'c_tarot_reading_used', extra = 25}},
        v_observatory=      {order = 12,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Observatory", pos = {x=3,y=3}, set = "Voucher", config = {extra = 1.5}, requires = {'v_telescope'},unlock_condition = {type = 'c_planetarium_used', extra = 25}},
        v_nacho_tong=       {order = 14,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Nacho Tong", pos = {x=5,y=1}, set = "Voucher", config = {extra = 1}, requires = {'v_grabber'},unlock_condition = {type = 'c_cards_played', extra = 2500}},
        v_recyclomancy=     {order = 16,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Recyclomancy", pos = {x=6,y=1}, set = "Voucher", config = {extra = 1}, requires = {'v_wasteful'},unlock_condition = {type = 'c_cards_discarded', extra = 2500}},
        v_tarot_tycoon=     {order = 18,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true,cost = 10, name = "Tarot Tycoon", pos = {x=1,y=1}, set = "Voucher", config = {extra = 32/4, extra_disp = 4}, requires = {'v_tarot_merchant'},unlock_condition = {type = 'c_tarots_bought', extra = 50}},
        v_planet_tycoon=    {order = 20,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true,cost = 10, name = "Planet Tycoon", pos = {x=2,y=1}, set = "Voucher", config = {extra = 32/4, extra_disp = 4}, requires = {'v_planet_merchant'},unlock_condition = {type = 'c_planets_bought', extra = 50}},
        v_money_tree=       {order = 22,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Money Tree", pos = {x=1,y=3}, set = "Voucher", config = {extra = 100}, requires = {'v_seed_money'},unlock_condition = {type = 'interest_streak', extra = 10}},
        v_antimatter=       {order = 24,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Antimatter", pos = {x=7,y=1}, set = "Voucher", config = {extra = 15}, requires = {'v_blank'},unlock_condition = {type = 'blank_redeems', extra = 10}},
        v_illusion=         {order = 26,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Illusion", pos = {x=4,y=3}, set = "Voucher", config = {extra = 4}, requires = {'v_magic_trick'},unlock_condition = {type = 'c_playing_cards_bought', extra = 20}},
        v_petroglyph=       {order = 28,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Petroglyph", pos = {x=5,y=3}, set = "Voucher", config = {extra = 1}, requires = {'v_hieroglyph'},unlock_condition = {type = 'ante_up', ante = 12, extra = 12}},
        v_retcon=           {order = 30,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Retcon", pos = {x=6,y=3}, set = "Voucher", config = {extra = 10}, requires = {'v_directors_cut'},unlock_condition = {type = 'blind_discoveries', extra = 25}},
        v_palette=          {order = 32,    discovered = false, demo = true, unlocked = false, start_locked = true, available = true, cost = 10, name = "Palette", pos = {x=7,y=3}, set = "Voucher", config = {extra = 1}, requires = {'v_paint_brush'},unlock_condition = {type = 'min_hand_size', extra = 5}},

        --Backs

        b_red=              {name = "Red Deck",         stake = 1, demo = false,unlocked = true,order = 1, pos =   {x=0,y=0}, set = "Back", config = {discards = 1}, discovered = true, start_discovered = true},
        b_blue=             {name = "Blue Deck",        stake = 1, demo = true, unlocked = false, start_locked = true, order = 2, pos =  {x=0,y=2}, set = "Back", config = {hands = 1}, unlock_condition = {type = 'discover_amount', amount = 20}},
        b_yellow=           {name = "Yellow Deck",      stake = 1, demo = false,unlocked = false, start_locked = true, order = 3, pos =  {x=1,y=2}, set = "Back", config = {dollars = 10}, unlock_condition = {type = 'discover_amount', amount = self.FTP_LOCKED and 20 or 50}},
        b_green=            {name = "Green Deck",       stake = 1, demo = true, unlocked = false, start_locked = true, order = 4, pos =  {x=2,y=2}, set = "Back", config = {extra_hand_bonus = 2, extra_discard_bonus = 1, no_interest = true}, unlock_condition = {type = 'discover_amount', amount = 75}},
        b_black=            {name = "Black Deck",       stake = 1, demo = true, unlocked = false, start_locked = true, order = 5, pos =  {x=3,y=2}, set = "Back", config = {hands = -1, joker_slot = 1}, unlock_condition = {type = 'discover_amount', amount = 100}},
        b_magic=            {name = "Magic Deck",       stake = 1, demo = false,unlocked = false, start_locked = true, order = 6, pos =  {x=0,y=3}, set = "Back", config = {voucher = 'v_crystal_ball', consumables = {'c_fool', 'c_fool'}}, unlock_condition = {type = 'win_deck', deck = 'b_red'}},
        b_nebula=           {name = "Nebula Deck",      stake = 1, demo = true, unlocked = false, start_locked = true, order = 7, pos =  {x=3,y=0}, set = "Back", config = {voucher = 'v_telescope', consumable_slot = -1}, unlock_condition = {type = 'win_deck', deck = 'b_blue'}},
        b_ghost=            {name = "Ghost Deck",       stake = 1, demo = true, unlocked = false, start_locked = true, order = 8, pos =  {x=6,y=2}, set = "Back", config = {spectral_rate = 2, consumables = {'c_hex'}}, unlock_condition = {type = 'win_deck', deck = 'b_yellow'}},
        b_abandoned=        {name = "Abandoned Deck",   stake = 1, demo = true, unlocked = false, start_locked = true, order = 9, pos =  {x=3,y=3}, set = "Back", config = {remove_faces = true}, unlock_condition = {type = 'win_deck', deck = 'b_green'}},
        b_checkered=        {name = "Checkered Deck",   stake = 1, demo = true, unlocked = false, start_locked = true, order = 10,pos =  {x=1,y=3}, set = "Back", config = {}, unlock_condition = {type = 'win_deck', deck = 'b_black'}},
        b_zodiac=           {name = "Zodiac Deck",      stake = 1, demo = true, unlocked = false, start_locked = true, order = 11, pos = {x=3,y=4}, set = "Back", config = {vouchers = {'v_tarot_merchant','v_planet_merchant', 'v_overstock_norm'}}, unlock_condition = {type = 'win_stake', stake = 2}},
        b_painted=          {name = "Painted Deck",     stake = 1, demo = true, unlocked = false, start_locked = true, order = 12, pos = {x=4,y=3}, set = "Back", config = {hand_size = 2, joker_slot = -1}, unlock_condition = {type = 'win_stake', stake=3}},
    ...
    -------------------------------------
    if not love.mod_filesystem.getInfo(G.SETTINGS.profile..'') then love.mod_filesystem.createDirectory( G.SETTINGS.profile..'' ) end

    local meta = G.FILES[G.SETTINGS.profile..'/'..'meta.jkr'] or {}
    meta.unlocked = meta.unlocked or {}
    meta.discovered = meta.discovered or {}
    meta.alerted = meta.alerted or {}
    
    for k, v in pairs(self.P_CENTERS) do
        if type(v.unlocked) == 'boolean' and v.start_locked then v.unlocked = false end
        if type(v.discovered) == 'boolean' and not v.start_discovered then v.discovered = false end
        if type(v.alerted) == 'boolean' and not v.start_alerted then v.alerted = false end

        if not G.FTP_LOCKED then v.demo = nil end
        if v.demo then 
            if v.order then v.order = v.order + 10000 end
            v.unlocked = false
            v.discovered = false
            v.alerted = true
        end
...
function Game:load_profile(_profile)
    ...
    --Load the settings file
    local info = G.FILES[_profile..'/profile.jkr']
    if info ~= nil then
        for k, v in pairs(info) do
            G.PROFILES[_profile][k] = v
        end
    end

    if not G.FILES[_profile..'/meta.jkr'] and G.PROFILES[_profile].collection_meta then
        G.FILES[_profile..'/meta.jkr'] = copy_table(G.PROFILES[_profile].collection_meta)
    end

    if G.FILES[_profile..'/meta.jkr'] then
        G.PROFILES[_profile].collection_meta = copy_table(G.FILES[_profile..'/meta.jkr'])
    end
...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ...
            ['de'] = {font = 1, label = "Deutsch", key = 'de', beta = nil, button = "Feedback zur Ãœbersetzung", warning = {'Diese Ãœbersetzung ist noch im Beta-Stadium. Willst du uns helfen,','sie zu verbessern? Dann klicke bitte auf die Feedback-Taste.', "Zum BestÃ¤tigen erneut klicken"}},
            ['es_419'] = {font = 1, label = "EspaÃ±ol (MÃ©xico)", key = 'es_419', beta = nil, button = "Sugerencias de idioma", warning = {'Este idioma todavÃ­a estÃ¡ en Beta. Pulsa el botÃ³n','de sugerencias para ayudarnos a mejorarlo.', "Haz clic de nuevo para confirmar"}},
            ['es_ES'] = {font = 1, label = "EspaÃ±ol (EspaÃ±a)", key = 'es_ES', beta = nil, button = "Sugerencias de idioma", warning = {'Este idioma todavÃ­a estÃ¡ en Beta. Pulsa el botÃ³n','de sugerencias para ayudarnos a mejorarlo.', "Haz clic de nuevo para confirmar"}},
            ['fr'] = {font = 1, label = "FranÃ§ais", key = 'fr', beta = nil, button = "Partager votre avis", warning = {'La traduction franÃ§aise est encore en version bÃªta. ','Veuillez cliquer sur le bouton pour nous donner votre avis.', "Cliquez Ã  nouveau pour confirmer"}},
            ...
            ['it'] = {font = 1, label = "Italiano", key = 'it', beta = nil, button = "Feedback traduzione", warning = {'Questa traduzione Ã¨ ancora in Beta. Per','aiutarci a migliorarla, clicca il tasto feedback', "Fai clic di nuovo per confermare"}},
            -- ['ja'] = {font = 5, label = "æ—¥æœ¬èªž", key = 'ja', beta = nil, button = "ææ¡ˆã™ã‚‹", warning = {'ã“ã®ç¿»è¨³ã¯ç¾åœ¨ãƒ™ãƒ¼ã‚¿ç‰ˆã§ã™ã€‚ææ¡ˆãŒã‚ã£ãŸå ´åˆã€','ãƒœã‚¿ãƒ³ã‚’ã‚¯ãƒªãƒƒã‚¯ã—ã¦ãã ã•ã„ã€‚', "ã‚‚ã†ä¸€åº¦ã‚¯ãƒªãƒƒã‚¯ã—ã¦ç¢ºèª"}},
            -- ['ko'] = {font = 4, label = "í•œêµ­ì–´", key = 'ko', beta = true, button = "ë²ˆì—­ í”¼ë“œë°±", warning = {'ì´ ì–¸ì–´ëŠ” ì•„ì§ ë² íƒ€ ë‹¨ê³„ì— ìžˆìŠµë‹ˆë‹¤. ','ë²ˆì—­ì„ ë„ì™€ì£¼ì‹œë ¤ë©´ í”¼ë“œë°± ë²„íŠ¼ì„ ëˆŒëŸ¬ì£¼ì„¸ìš”.', "ë‹¤ì‹œ í´ë¦­í•´ì„œ í™•ì¸í•˜ì„¸ìš”"}},
            ...
            ['pl'] = {font = 1, label = "Polski", key = 'pl', beta = nil, button = "WyÅ›lij uwagi do tÅ‚umaczenia", warning = {'Polska wersja jÄ™zykowa jest w fazie Beta. By pomÃ³c nam poprawiÄ‡',' jakoÅ›Ä‡ tÅ‚umaczenia, kliknij przycisk i podziel siÄ™ swojÄ… opiniÄ… i uwagami.', "Kliknij ponownie, aby potwierdziÄ‡"}},
            ['pt_BR'] = {font = 1, label = "PortuguÃªs", key = 'pt_BR', beta = nil, button = "Feedback de TraduÃ§Ã£o", warning = {'Esta traduÃ§Ã£o ainda estÃ¡ em Beta. Se quiser nos ajudar','a melhorÃ¡-la, clique no botÃ£o de feedback por favor', "Clique novamente para confirmar"}},
            -- ['ru'] = {font = 6, label = "Ð ÑƒÑÑÐºÐ¸Ð¹", key = 'ru', beta = true, button = "ÐžÑ‚Ð·Ñ‹Ð² Ð¾ ÑÐ·Ñ‹ÐºÐµ", warning = {'Ð­Ñ‚Ð¾Ñ‚ ÑÐ·Ñ‹Ðº Ð²ÑÐµ ÐµÑ‰Ðµ Ð½Ð°Ñ…Ð¾Ð´Ð¸Ñ‚ÑÑ Ð² Ð‘ÐµÑ‚Ð°-Ð²ÐµÑ€ÑÐ¸Ð¸. Ð§Ñ‚Ð¾Ð±Ñ‹ Ð¿Ð¾Ð¼Ð¾Ñ‡ÑŒ','Ð½Ð°Ð¼ ÐµÐ³Ð¾ ÑƒÐ»ÑƒÑ‡ÑˆÐ¸Ñ‚ÑŒ, Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ Ð¾Ð±Ñ€Ð°Ñ‚Ð½Ð¾Ð¹ ÑÐ²ÑÐ·Ð¸.', "Ð©ÐµÐ»ÐºÐ½Ð¸Ñ‚Ðµ ÑÐ½Ð¾Ð²Ð°, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð¿Ð¾Ð´Ñ‚Ð²ÐµÑ€Ð´Ð¸Ñ‚ÑŒ"}},
            -- ['zh_CN'] = {font = 2, label = "ç®€ä½“ä¸­æ–‡", key = 'zh_CN', beta = nil, button = "æ„è§åé¦ˆ", warning = {'è¿™ä¸ªè¯­è¨€ç›®å‰å°šä¸ºBetaç‰ˆæœ¬ã€‚ è¯·å¸®åŠ©æˆ‘ä»¬æ”¹å–„ç¿»è¯‘å“è´¨ï¼Œ','ç‚¹å‡»â€æ„è§åé¦ˆâ€ æ¥æä¾›ä½ çš„æ„è§ã€‚', "å†æ¬¡ç‚¹å‡»ç¡®è®¤"}},
            -- ['zh_TW'] = {font = 3, label = "ç¹é«”ä¸­æ–‡", key = 'zh_TW', beta = nil, button = "æ„è¦‹å›žé¥‹", warning = {'é€™å€‹èªžè¨€ç›®å‰å°šç‚ºBetaç‰ˆæœ¬ã€‚è«‹å¹«åŠ©æˆ‘å€‘æ”¹å–„ç¿»è­¯å“è³ªï¼Œ','é»žæ“Šâ€æ„è¦‹å›žé¥‹â€ ä¾†æä¾›ä½ çš„æ„è¦‹ã€‚', "å†æŒ‰ä¸€ä¸‹å³å¯ç¢ºèª"}},
        ...
        self.FONTS = {
            ...
            -- {file = "resources/fonts/NotoSansSC-Bold.ttf", render_scale = self.TILESIZE*7/3, TEXT_HEIGHT_SCALE = 0.7, TEXT_OFFSET = {x=0,y=-13}, FONTSCALE = 0.36, squish = 1, DESCSCALE = 1.1},
            -- {file = "resources/fonts/NotoSansTC-Bold.ttf", render_scale = self.TILESIZE*7/3, TEXT_HEIGHT_SCALE = 0.7, TEXT_OFFSET = {x=0,y=-13}, FONTSCALE = 0.36, squish = 1, DESCSCALE = 1.1},
...
function Game:init_window(reset)
    ...
    self.ROOM_PADDING_H= 0.4--0.7
    self.ROOM_PADDING_W = 0.8--1
    self.WINDOWTRANS = {
        x = 0, y = 0,
        w = self.TILE_W+2*self.ROOM_PADDING_W, 
        h = self.TILE_H+3*self.ROOM_PADDING_H
    }
    self.window_prev = {
...
function Game:save_progress()
    ...
    local meta = G.FILES[G.SETTINGS.profile..'/meta.jkr'] or {}
    G.FILES[G.SETTINGS.profile..'/meta.jkr'] = meta
    ...
    for k, v in pairs(self.P_CENTERS) do
        meta.unlocked[k], meta.discovered[k], meta.alerted[k] = v.unlocked or nil, v.discovered or nil, v.alerted or nil
    end
    for k, v in pairs(self.P_BLINDS) do
        meta.unlocked[k], meta.discovered[k], meta.alerted[k] = v.unlocked or nil, v.discovered or nil, v.alerted or nil
    end
    ...
    meta.ver = G.PROFILES[G.SETTINGS.profile].ver or 0
    
    G.ARGS.save_progress.META = meta

    G.FILES[G.SETTINGS.profile..'/meta.jkr'] = meta
    G.FILES[G.SETTINGS.profile..'/profile.jkr'] = G.ARGS.save_progress.PROFILE

    if G.PROFILES and G.PROFILES[G.SETTINGS.profile] then
        G.PROFILES[G.SETTINGS.profile].collection_meta = copy_table(meta)
    end
end

function Game:load_all_files(_retry_cloud)
    G.LOAD_HANDLER = G.LOAD_HANDLER or {}

    G.LOAD_HANDLER.LOCAL_FILES = G.LOAD_HANDLER.LOCAL_FILES or {
        ["settings.jkr"] = true,
        ["1/save.jkr"] = true,
        ["2/save.jkr"] = true,
        ["3/save.jkr"] = true,
        ["1/unlock_notify.jkr"] = true,
        ["2/unlock_notify.jkr"] = true,
        ["3/unlock_notify.jkr"] = true,
    }

    G.LOAD_HANDLER.FILE_NAMES = G.LOAD_HANDLER.FILE_NAMES or {
        'settings.jkr',
        '1/profile.jkr',
        '1/save.jkr',
        '1/meta.jkr',
    ...
    if _retry_cloud then 
        G.LOAD_HANDLER.FILE_STATUS = G.LOAD_HANDLER.FILE_STATUS or {}
        for k, v in ipairs(G.LOAD_HANDLER.FILE_NAMES) do
            if not G.LOAD_HANDLER.LOCAL_FILES[v] then 
                G.LOAD_HANDLER.FILE_STATUS[v] = {
                    _status = 'LOADING',
                    _contents = nil,
                    _code = nil
                }
...
function Game:load_file(_file)
    ...
    if G.LOAD_HANDLER.LOCAL_FILES and G.LOAD_HANDLER.LOCAL_FILES[_file] or true then
...
function Game:empty_profile(_profile)
    G.ARGS.save_settings = G.SETTINGS
    G.FILE_HANDLER = G.FILE_HANDLER or {}
    G.FILE_HANDLER.empty_profile = _profile
    G.FILE_HANDLER.update_queued = true

    G.PROFILES[_profile] = {deleted = true, ver = G.SETTINGS.profile_counters[_profile] or 0, flags = (G.PROFILES[_profile] and G.PROFILES[_profile].flags or nil)}

    G.FILES[_profile..'/profile.jkr'] = G.PROFILES[_profile]
end


function Game:save_notify(card)
    G.SAVE_HANDLER = G.SAVE_HANDLER or {}
    G.SAVE_HANDLER.saving = G.SAVE_HANDLER.saving or 0
    G.SAVE_HANDLER.saving = G.SAVE_HANDLER.saving + 1
    -- G.SAVE_MANAGER.request_channel:push({ -- modify by newfarking
    saveAction({ -- modify by newfarking
        type = 'save_notify',
...
function Game:refresh()
    ...
    G.PROGRESS = nil
    G.focused_profile = G.SETTINGS.profile or 1 
...
function Game:show_offline_message()
    RESET_STATES(G.STATES.MENU)
    self:prep_stage(G.STAGES.ASYNC_LIMBO, G.STATES.ASYNC_OFFLINE, true)
    ...
    G.SPLASH_BACK:define_draw_steps({{
        ...
        send = {
            ...
            {name = 'vort_speed', val = 0.4},
            {name = 'colour_1', ref_table = G.C, ref_value = 'GREY'},
...
function Game:wait_for_async()
    RESET_STATES(G.STATES.MENU)
    self:prep_stage(G.STAGES.ASYNC_LIMBO, G.STATES.ASYNC_WAIT, true)
    ...
    G.E_MANAGER:add_event(Event({
        ...
        blocking = false,
        func = (function()
        if not G.LOAD_HANDLER.loading then
            G:delete_run()
            G:main_menu()
            return true
        end
...
function Game:main_menu(change_context) --True if main menu is accessed from the splash screen, false if it is skipped or accessed from the game
    love.platform = {}
    love.platform.isOffline = function() return true end
    ...
    if not G.offline_warned and love.platform and love.platform.isOffline then
        if love.platform.isOffline() then
            ...
            G:delete_run()
            G.offline_screen = nil
            G.loading_message = nil
            G:refresh();
            G:main_menu()
    ...
    if (not G.SETTINGS.tutorial_complete) and G.SETTINGS.tutorial_progress.completed_parts['big_blind'] then set_cloud_flag('tutorial_complete') end

    if G.SETTINGS.tutorial_complete and G.SETTINGS.tutorial_progress then 
    ...
    local special_main_menu = G.ACHIEVEMENTS.completionist_plus_plus.earned and 3 or G.ACHIEVEMENTS.completionist_plus.earned and 2 or G.ACHIEVEMENTS.completionist.earned and 1 or 0
    ...
    G.SPLASH_BACK:define_draw_steps({{
        ...
        send = {
            {name = 'time', ref_table = G.TIMERS, ref_value = 'REAL_SHADER'},
            {name = 'vort_speed', val = 0.4},
            {name = 'colour_1', ref_table = G.C, ref_value = 
                special_main_menu == 3 and 'BLUE'
                or 'RED'},
            {name = 'colour_2', ref_table = G.C, ref_value = 
                special_main_menu == 3 and 'RED'
                or 'BLUE'},
            {name = 'mid_flash', ref_table = splash_args, ref_value = 'mid_flash'},
            {name = 'vort_offset', val = 0},
        }}})

    --Display the missing controller message if required
    G.E_MANAGER:add_event(Event({
        trigger = 'immediate',
        blockable = false,
        blocking = false,
        ...
        pause_force = true,
        func = (function()
            if self.F_CONTROLLER_REQUIRED then 
                local joysticks, valid_controller = love.joystick.getJoysticks(), nil
                if joysticks then 
                    for k, v in pairs(joysticks) do
                        if v:getName() ~= 'Remote' then 
                            valid_controller = v
                        end
                    end
                    if valid_controller then 
                        self.CONTROLLER:set_gamepad(valid_controller)
                        G.FUNCS.exit_overlay_menu()
                        return true
                    else
                        if not G.OVERLAY_MENU then 
                            create_controller_required_overlay(_name)
                        end
                    end
                end
    ...
    G.E_MANAGER:add_event(Event({
        ...
        func = (function()
                set_main_menu_UI()
                if love.platform and love.platform.requestTrackingPermission then love.platform.requestTrackingPermission() end
                self.FUNCS.gamecenter_login()
                return true
            end)
        }))

    --Do all career stat unlock checking here as well
    print("G.PROFILES[G.SETTINGS.profile]"..G.SETTINGS.profile)
    print(G.PROFILES[G.SETTINGS.profile].career_stats)
...
function Game:start_run(args)
    ...
    analytic_event('new_run',
            'demo_flag', not G.FTP_LOCKED,
            'deck', self.GAME.selected_back.name or 'error',
            'stake', self.GAME.stake or 'error',
            'language', self.SETTINGS.language or 'error',
            'from_load', not not saveTable)
...
function Game:update(dt)
    if G.FTP_LOCKED and G.STATE ~= G.STATES.SPLASH then
        if G.MAIN_MENU_UI then
            local _play_button = G.MAIN_MENU_UI:get_UIE_by_ID('main_menu_play')
            if _play_button and not _play_button.children.alert then
                _play_button.children.alert = UIBox{
                definition = create_UIBox_card_alert({text_rot = -0.2, no_bg = true,text = localize('k_demo_version_ex'), scale = 0.4}),
                config = {
                  align="tli",
                  offset = {x = -0.1, y = 0},
                  major = _play_button}
              }
              _play_button.children.alert.states.collide.can = false
            end
          end
    end

    if love.platform and love.platform.setProfileButtonActive then
        love.platform.setProfileButtonActive(G.STAGE == G.STAGES.MAIN_MENU)
    end
    ...
    if not G.SETTINGS.paused then G.profile_display = (G.PROFILES and G.PROFILES[G.SETTINGS.profile] and G.PROFILES[G.SETTINGS.profile].name) or 'ERROR' end
        ...
        if self.STATE == self.STATES.ASYNC_WAIT then
            self:update_async_load_screen()
        end

        if self.STATE == self.STATES.ASYNC_OFFLINE then
            self:update_async_offline()
        end
    ...
    --Handle any asynchronous loading
    if G.LOAD_HANDLER and G.LOAD_HANDLER.loading then
        --pop from the load thread
        local load_resp = G.LOAD_MANAGER.return_channel:pop()
        if load_resp then
            local _file, _status, _upgrade = load_resp._filename, load_resp._status, load_resp._upgrade
            --handle the response
            --OK = load the file
            if _status == 'OK' then
                G.FILES[_file] = load_resp._content
                G.LOAD_HANDLER.FILE_STATUS[_file]._status = _status
            end

            --NOT FOUND = no file
            if _status == 'NOT FOUND' then
                G.LOAD_HANDLER.FILE_STATUS[_file]._status = _status
            end
            
            if _upgrade then 
                local _file_profile = string.sub(_file, 1, 2)

                local _UN = get_compressed(_file_profile..'/'..'unlock_notify.jkr')
                if _UN then 
                    love.mod_filesystem.remove(_file_profile..'/'..'unlock_notify.jkr')
                end
                local _save = get_compressed(_file_profile..'/'..'save.jkr')
                if _save then 
                    love.mod_filesystem.remove(_file_profile..'/'..'save.jkr')
                end
                G.FILES[_file_profile..'/'..'save.jkr'] = nil
            end
        end

        local _success = true
        for k, v in pairs(G.LOAD_HANDLER.FILE_STATUS) do
            if (v._status ~= 'OK') and (v._status ~= 'NOT FOUND') then
                _success = nil
            -- else
                -- print("files not ready"..k)
            end
        end
        if _success then
            G:refresh()
            G.LOAD_HANDLER.loading = nil
        end
    end
    --Handle any conflicts from async saving
    if G.SAVE_HANDLER and G.SAVE_HANDLER.saving > 0 then
        --pop from the save thread
        local save_resp = G.SAVE_MANAGER.return_channel:pop()
        if save_resp then
            local _file, _status, _content = save_resp._filename, save_resp._status, save_resp._content
            --handle the response
            --OK = file was saved
            G.SAVE_HANDLER.saving = G.SAVE_HANDLER.saving - 1
            --if _status == 'OK' then
            ...
            --end
            --CONFLICT = there is a resolved conflict, load the new file
            if _status == 'CONFLICT' then
                G.CONFLICTING_FILES = G.CONFLICTING_FILES or {}
                G.CONFLICTING_FILES[_file] = _content
                G.SAVE_HANDLER.conflict = true
				if _upgrade then 
                    local _file_profile = string.sub(_file, 1, 2)
                    local _UN = get_compressed(_file_profile..'/'..'unlock_notify.jkr')
                    if _UN then 
        ...
        if G.SAVE_HANDLER and G.SAVE_HANDLER.conflict and not G.OVERLAY_MENU then
            for k, v in pairs(G.CONFLICTING_FILES) do
                G.FILES[k] = v
                G.CONFLICTING_FILES[k] = nil
            end
            G:refresh()
            G.SAVE_HANDLER.conflict = nil
        end
    end
    --Update the profile version for all profiles
    for k, v in pairs(G.PROFILES) do
        if v.ver and (v.ver > G.SETTINGS.profile_counters[k]) then 
            G.SETTINGS.profile_counters[k] = v.ver
        end

        if not v.ver or (v.ver < G.SETTINGS.profile_counters[k]) then 
            v.ver = G.SETTINGS.profile_counters[k]
        end
    end
    ...
    if G.FILE_HANDLER and G.FILE_HANDLER.update_queued and (not G.LOAD_HANDLER.loading) and (
        ...
        (not G.FILE_HANDLER.last_sent_time or (G.FILE_HANDLER.last_sent_time < (G.TIMERS.UPTIME - G.F_SAVE_TIMER)))) then 
            ...
            elseif G.FILE_HANDLER.empty_profile then
                G.SAVE_HANDLER.saving = G.SAVE_HANDLER.saving + 1
                ...
                saveAction({ -- modify by newfarking
                    ...
                    profile_num = G.FILE_HANDLER.empty_profile,
                    save_profile = G.PROFILES[G.FILE_HANDLER.empty_profile]
                  })
...
function Game:draw()
    ...
    for k, v in pairs(G.STAGE_OBJECTS[G.STAGE]) do
        v.under_overlay = not not self.OVERLAY_TUTORIAL
    end
...
love.graphics.pop()
    ...
    if not _RELEASE_MODE and not G.video_control and G.F_VERBOSE then 
        ...
        if DB_TAB then
            local db_keys = {}
            for k in pairs(DB_TAB) do table.insert(db_keys, k) end
            table.sort(db_keys)
            for _row, k in ipairs(db_keys) do love.graphics.print(k..": "..DB_TAB[k], 10, _row*20 + 30) end
        end
                        ...
                        func = function()
                            if math.abs(G.shop.T.y - G.shop.VT.y) < 3 then
                                ...
                                if not shop_exists then
                                    ...
                                    if G.FTP_LOCKED and G.shop_demo then G.shop_demo:emplace(create_card('Demo', G.shop_demo)) end
...
function Game:update_async_load_screen(dt)
    if G.offline_screen then G.offline_screen:remove(); G.offline_screen = nil end
    if not G.loading_message then
        G.loading_message = UIBox{
            definition = create_UIBox_loading_screen(),
            config = {align="cm", offset = {x=0,y=0},major = G.ROOM_ATTACH}
        }
    end
end

function Game:update_async_offline(dt)
    if G.loading_message then G.loading_message:remove(); G.loading_message = nil end
    if not G.offline_screen then
        G.offline_screen = UIBox{
            definition = create_UIBox_offline(),
            config = {align="cm", offset = {x=0,y=0},major = G.ROOM_ATTACH}
        }
    end
end
