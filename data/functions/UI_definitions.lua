    ...
    {n=G.UIT.R, config={align = "cm", padding = 0}, nodes={
      {n=G.UIT.C, config={align = "cm", padding = 0.1, minw = 9, minh = 4.2}, nodes={
        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes=G.UIDEF.multiline_credit_text({
          ...
          'reproduced in any form or by any meansâ€” graphic,',
          'electronic, or mechanical, including recording,',
          'online distribution, or information storage and retrieval',
          'systemsâ€”without the written permission of the publisher',
                  ...
                  {n=G.UIT.C, config={align = "cm", padding = 0.1,outline_colour = G.C.JOKER_GREY, r = 0.1, outline = 1}, nodes={
                    ...
                    {n=G.UIT.R, config={align = "tm", padding = 0}, nodes={
                      ...
                      {n=G.UIT.C, config={align = "tl", padding = 0.05}, nodes={
                        ...
                        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes={
                          {n=G.UIT.T, config={text = 'RomÃ¡n RenÃ© Orozco, Javier GÃ³mez', scale = text_scale*0.35, colour = G.C.UI.TEXT_LIGHT, shadow = true}},
                        }},
                        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes={
                          {n=G.UIT.T, config={text = 'Romain Vervaecke, Claire GÃ©rard', scale = text_scale*0.35, colour = G.C.UI.TEXT_LIGHT, shadow = true}},
                        }},
                        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes={
                        ...
                        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes={
                          {n=G.UIT.T, config={text = 'Ruoyang Yuan, Tania CarÃ¨', scale = text_scale*0.35, colour = G.C.UI.TEXT_LIGHT, shadow = true}},
                        }},
                      }},
                    }},
                  }},
                  ...
                  {n=G.UIT.C, config={align = "cm", padding = 0.1,outline_colour = G.C.JOKER_GREY, r = 0.1, outline = 1}, nodes={
                    ...
                    {n=G.UIT.R, config={align = "tm", padding = 0}, nodes={
                      ...
                      {n=G.UIT.C, config={align = "tl", padding = 0.05}, nodes={
                        ...
                        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes={
                          {n=G.UIT.T, config={text = 'Ela MÃ¼ller', scale = text_scale*0.42, colour = G.C.UI.TEXT_LIGHT, shadow = true}},
                        }},
                        {n=G.UIT.R, config={align = "cl", padding = 0}, nodes={
              ...
              tab_definition_function = function()
                G.collab_credits = G.collab_credits or {
                  ...
                  [G.F_BABYNAMES and 'The Continent' or 'The Witcher'] = {
                    artist = nil,
                    ml_text = {
                      'Â© 2024 CD PROJEKT S.A. All rights reserved. CD PROJEKT,',
                  ...
                  [G.F_BABYNAMES and 'Night City' or 'Cyberpunk 2077'] = {
                    artist = nil,
                    ml_text = {
                      'Cyberpunk 2077 Â© 2024 CD PROJEKT S.A. All rights reserved.'
                    },
                    art = 'collab_CYP'
                  },
                  ['Shovel Knight'] = {
                    ...
                    ml_text = {
                      'Shovel Knight Â© 2024 Yacht Club Games, LLC. All Rights Reserved.'
                    },
                    art = 'collab_SK'
                  },
                  [G.F_BABYNAMES and 'Nightmare Throne' or 'Don\'t Starve'] = {
                    artist = nil,
                    ml_text = {
                      'â€œKLEIâ€ â€œDON\'T STARVEâ€ Â© 2024 All Rights Reserved',
                  ...
                  [G.F_BABYNAMES and 'Ezio and Friends' or 'Assassin\'s Creed'] = {
                    artist = 'Franek',
                    ml_text = {
                      'Assassin\'s Creed Â© 2025 Ubisoft Entertainment.',
                      'All Rights Reserved.'
                    },
                    art = 'collab_AC'
                  },
                  ...
                  ['Among Us'] = {
                    artist = nil,
                    ml_text = {
                      'Among Us Â© 2024 Innersloth LLC. All Rights Reserved.'
                    },
                    art = 'collab_AU'
                  },
                  ...
                  [G.F_BABYNAMES and 'Lambs in a Cult' or 'Cult of the Lamb'] = {
                    artist = nil,
                    ml_text = {
                      'Cult of the Lamb Â© 2024 Massive Monster All Rights Reserved'
                    },
                    art = 'collab_CL'
                  },
                  [G.F_BABYNAMES and 'Rivellon Pack' or 'Divinity Original Sin 2'] = {
                    artist = nil,
                    ml_text = {
                      'Â©2024 Larian Studios. Larian Studios, Divinity, Divinity: Original Sin',
                  ...
                  ['Critical Role'] = {
                    ...
                    ml_text = {
                      '2025 Â© Gilmoreâ€™s Glorious Goods LLC. All Rights Reserved.',
                  ...
                  ['Bugsnax'] = {
                    ...
                    artist_link = 'twitch.tv/neato',
                    ml_text = {
                      'Â© 2025 Bugsnax Â© Young Horses Inc. All Rights Reserved.'
                    },
                    art = 'collab_BUG'
                  },
                  ...
                  ['Slay the Spire'] = {
                    ...
                    artist_link = 'twitch.tv/neato',
                    ml_text = {
                      'Slay the Spire Â©2024 Mega Crit Games, LLC. All Rights Reserved.'
                    },
                    art = 'collab_STS'
                  },
                  ['Potion Craft'] = {
                    artist = nil,
                    ml_text = {
                      'Potion Craft Â© 2024 tinyBuild, LLC. All Rights Reserved.'
                    },
                    art = 'collab_PC'
                  },
                  [G.F_BABYNAMES and 'Tenno Awakening' or 'Warframe'] = {
                    artist = nil,
                    ml_text = {
                      'Warframe Â©2024 Digital Extremes Ltd. All rights reserved. Warframe',
                  ...
                  [G.F_BABYNAMES and 'The Fog' or 'Dead By Daylight'] = {
                    artist = nil,
                    ml_text = {
                      'Â© 2015-2025 and BEHAVIOUR, DEAD BY DAYLIGHT and other related trademarks',
                  ...
                  ['Dave the Diver'] = {
                    artist = nil,
                    ml_text = {
                      'Dave the Diver Â© Mintrocket. All Rights Reserved.'
                    },
                    art = 'collab_DTD'
                  },
                  ['Stardew Valley'] = {
                  ...
                  [G.F_BABYNAMES and 'Bullet Kin' or 'Enter the Gungeon'] = {
                    artist = nil,
                    ml_text = {
                      'Enter the Gungeon Â© 2024 Devolver Digital Inc.All Rights Reserved.'
                    },
                    art = 'collab_EG'
                  },
                  ...
                  ['Civilization VII'] = {
                    ...
                    ml_text = {
                      ...
                      'Â© 2025 Take-Two Interactive Software, Inc. and its subsidiaries.'
                    },
                    art = 'collab_C7'
                  },
            ...
            },
            {
              ...
              tab_definition_function = function() return 
                {n=G.UIT.ROOT, config={align = "cm", padding = 0.2, colour = G.C.BLACK, r = 0.1, emboss = 0.05, minh = 6, minw = 10}, nodes={
                  ...
                  {n=G.UIT.R, config={align = "cm", padding = 0}, nodes={
                    {n=G.UIT.T, config={text = "Â©2024 - All rights reserved", scale = text_scale*0.6, colour = G.C.BLUE, shadow = true}},
                  }},
                }}
              end,
            },
